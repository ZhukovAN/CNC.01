...
#include "hyvfd_port.h"

/* Table of CRC values for high-order byte */
static uint8_t table_crc_hi[] = { 0x00, 0xC1, 0x81, 0x40, 0x01, 0xC0,
...
static uint8_t table_crc_lo[] = { 0x00, 0xC0, 0xC1, 0x01, 0xC3, 0x03,
...
static int8_t check_crc16(uint8_t *msg, const uint8_t msg_length) {
	uint16_t crc_calc;
	...
	/* Check CRC of msg */
	return (crc_calc == crc_received) ? 0 : INVALID_CRC;
}
...
static unsigned int compute_response_length(uint8_t *query) {
	switch (query[1]) {
		case FUNCTION_READ:
